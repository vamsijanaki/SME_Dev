...
//                        $totalScore +=$ans->
    ...
    public function contactMsgSubmit(Request $request)
    {
        ...
        $admin = User::where('role_id', 1)->first();
            ...
            if (UserEmailNotificationSetup('CONTACT_MESSAGE',$admin)) {
                ...
                if (UserBrowserNotificationSetup('CONTACT_MESSAGE',$admin)) {

                    send_browser_notification($admin, $type = 'CONTACT_MESSAGE', $shortcodes = [
                        'name' => $name,
                        'email' => $email,
                        'message' => $message,
                        'subject' => $subject
