                ...
                {{-- Start Certificate Number Section --}}
                    ...
                    <div class="row mt-25 padding_40">
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="yes12">{{__('certificate.Yes')}}</label>
                        </div>
                        <div class="col-md-6">
                            <input onclick="getNew()" type="radio"
                            ...
                            <label for="no12">{{__('certificate.No')}}</label>
                        </div>
                    </div>
