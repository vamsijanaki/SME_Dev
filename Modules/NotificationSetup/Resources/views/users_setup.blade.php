                        ...
                        <div class="col-lg-12 p-0">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade active show" id="group_email_sms">
                                    ...
                                    <form action="{{route('UpdateUserNotificationControll')}}" name="instructor_notification_setup_form" class="instructor_notification_setup_form" method="POST">
                                             ...
                                             <table  class="Crm_table_active3">
                                                ...
                                                @foreach($instructor_temps as $temp)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                             <label class="primary_checkbox d-flex mr-12 " for="email_option_check_{{$temp->id}}" yes="">
                                                                <input type="checkbox"  id="email_option_check_{{$temp->id}}" name="status[{{$temp->id}}]"
                                ...
                                <div role="tabpanel" class="tab-pane fade
                                    ...
                                    <div class="QA_section QA_section_heading_custom check_box_table mt-20">
                                        <form action="{{route('UpdateUserNotificationControll')}}" name="student_notification_setup_form" class="student_notification_setup_form" method="POST">
                                ...
                                <div role="tabpanel" class="tab-pane fade
                                    ...
                                    <div class="QA_section QA_section_heading_custom check_box_table mt-20">
                                   <form action="{{route('UpdateUserNotificationControll')}}" name="staff_notification_setup_form" class="staff_notification_setup_form" method="POST">
