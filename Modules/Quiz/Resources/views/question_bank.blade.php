                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-4">
                                            ...
                                            <select {{ $errors->has('question_type') ? ' autofocus' : '' }}
                                                ...
                                                <option value="M" {{isset($bank)? $bank->type == "M"? 'selected': '' : ''}}> {{__('Multiple Choice')}}</option>
                                                <option value="S" {{isset($bank)? $bank->type == "S"? 'selected': '' : ''}}> {{__('Short Answer')}} </option>
                                                <option value="L" {{isset($bank)? $bank->type == "L"? 'selected': '' : ''}}> {{__('Long Answer')}} </option>
                                            </select>
