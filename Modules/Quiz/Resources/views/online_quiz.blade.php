                                        ...
                                        <div class="col-lg-12 ">
                                            ...
                                            <div class="d-flex radio-btn-flex  ">
                                                <div class="mr-30 row">
                                                    ...
                                                    <label for="change_default_settings">{{__('quiz.Yes')}}</label>
                                                </div>
                                                <div class="mr-30 row">
                                                    <input type="radio" name="change_default_settings"
                                                           ...
                                                           @if (!isset($online_exam)) checked
                                                           @endif  class="common-radio change-default-settings relationButton">
                                                    <label for="change_default_settings2">{{__('quiz.No')}}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-12 mb-25">
                                            <div class="input-effect">
                                                ...
                                                <input
                                                    ...
                                                    type="number" name="question_time" autocomplete="off" min="0"
                                                    step="any"
                                                    value="{{$question_time}}">
