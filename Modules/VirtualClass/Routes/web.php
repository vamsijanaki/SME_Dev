...
Route::group(['prefix' => 'virtualclass', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/all/virtual-class-data', 'VirtualClassController@getAllVirtualClassData')->name('getAllVirtualClassData')->middleware('RoutePermissionCheck:student.student_list');
