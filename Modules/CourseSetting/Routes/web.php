...
Route::group(['prefix' => 'admin/course', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/course-students/{course_id}', 'CourseInvitationController@enrolled_students')->name('course.enrolled_students')->middleware('RoutePermissionCheck:course.enrolled_students');
    Route::get('/course-students-list/{course_id}', 'CourseInvitationController@getAllStudentData')->name('course.getAllStudentData')->middleware('RoutePermissionCheck:course.getAllStudentData');
