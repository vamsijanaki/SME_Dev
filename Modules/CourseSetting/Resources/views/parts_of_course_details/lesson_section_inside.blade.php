                            ...
                            @else
                                <div class="input-effect mt-2 pt-1">
                                    <label class="primary_input_label mt-1"
                                           for=""> {{__('courses.Host')}}
                                        <span>*</span></label>
                                        <p style="font-size:12px;">Note : We only support PDF for document host, So please convert your doc into PDF and upload.
                                ...
                                @if(isModuleActive('SCORM'))
                                    <div class="input-effect mt-2 pt-1 {{ isset($editLesson) && $editLesson->host != 'SCORM' ? 'd-none' : '' }}" id="scorm_vendor_type">
                                        <div class="" id="">
                                            <label class="primary_input_label mt-1"
                                            ...
                                            <select class="primary_select" name="scorm_vendor_type">
                                                ...
                                                @endif
                                                <option {{isset($editLesson) ? $editLesson->scorm_vendor_type=='ispring'? 'selected':'':'' }}
                                                        value="ispring">{{__('courses.Ispring')}} </option>

                                                <option {{isset($editLesson) ? $editLesson->scorm_vendor_type=='storyline'? 'selected':'':'' }}
                                                        value="storyline">{{__('courses.Story Line')}} </option>

                                                <option {{isset($editLesson) ? $editLesson->scorm_vendor_type=='other'? 'selected':'':'' }}
