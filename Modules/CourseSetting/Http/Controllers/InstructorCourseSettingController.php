        ...
        if ($request->input_type == 1) {
            try {
                ...
                if (isset($course)) {
                    ...
                    if (UserEmailNotificationSetup('Course_Chapter_Added',Auth::user())) {
                    ...
                    if (UserBrowserNotificationSetup('Course_Chapter_Added',Auth::user())) {

                        send_browser_notification(Auth::user(), $type = 'Course_Chapter_Added', $shortcodes = [
                            'time' => Carbon::now()->format('d-M-Y ,s:i A'),
                            'course' => $course->title,
                            'chapter' => $chapter->name,
                        ],
            ...
            try {
                ...
                if (UserEmailNotificationSetup('Course_Quiz_Added',Auth::user())) {
                ...
                if (UserBrowserNotificationSetup('Course_Quiz_Added',Auth::user())) {

                    send_browser_notification(Auth::user(), $type = 'Course_Quiz_Added', $shortcodes = [
                        'time' => Carbon::now()->format('d-M-Y ,s:i A'),
                        'course' => $course->title,
                        'chapter' => $chapter->name,
                        'quiz' => $quiz->title,
            ...
            try {
                ...
                if (isset($course) && isset($chapter)) {
                    ...
                    $lesson->save();
                       ...
                       if (UserEmailNotificationSetup('Course_Lesson_Added',Auth::user())) {
                        ...
                        if (UserBrowserNotificationSetup('Course_Lesson_Added',Auth::user())) {

                            send_browser_notification(Auth::user(), $type = 'Course_Lesson_Added', $shortcodes = [
                                'time' => Carbon::now()->format('d-M-Y ,s:i A'),
                                'course' => $course->title,
                                'chapter' => $chapter->name,
                                'lesson' => $lesson->name,
    ...
    public function saveFile(Request $request)
    {
        ...
        try {
            ...
            $course_file->save();
                ...
                if (UserEmailNotificationSetup('Course_ExerciseFile_Added',Auth::user())) {
                ...
                if (UserBrowserNotificationSetup('Course_ExerciseFile_Added',Auth::user())) {

                    send_browser_notification(Auth::user(), $type = 'Course_ExerciseFile_Added', $shortcodes = [
                       'time' => Carbon::now()->format('d-M-Y ,s:i A'),
                        'course' => Course::find($request->id)->first(['title'])->title,
                        'filename' => $course_file->fileName,
                    ],
