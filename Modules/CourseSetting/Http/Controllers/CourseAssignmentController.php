    ...
    public function AssignmentStore(Request $request)
    {
        ...
        try {
            ...
            if (isset($course) && isset($chapter)) {
                ...
                if (UserEmailNotificationSetup('Course_Assignment_Added',Auth::user())) {
                ...
                if (UserBrowserNotificationSetup('Course_Assignment_Added',Auth::user())) {

                    send_browser_notification(Auth::user(), $type = 'Course_Assignment_Added', $shortcodes = [
                        'time' => Carbon::now()->format('d-M-Y ,s:i A'),
                        'course' => $course->title,
                        'chapter' => $chapter->name,
                        'assignment' => $assignment->title,
