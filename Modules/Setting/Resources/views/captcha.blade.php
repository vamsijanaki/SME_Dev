                    ...
                    <form class="form-horizontal" action="{{route('setting.captcha')}}" method="POST">
                        ...
                        <div class="white-box">
                            <div class="col-lg-12 text-right">
                                <code>NB: Using Google reCaptcha v2 (invisible & checkbox)| <a target="_blank"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <input type="radio"
                                                                   ...
                                                                   value="1">
                                                            <label
                                                                for="yes_is_invisible">{{__('common.Yes')}}</label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="radio"
                                                                   ...
                                                                   value="0">
                                                            <label
                                                                for="no_is_invisible">{{__('common.No')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <input type="radio"
                                                                           ...
                                                                           value="1">
                                                                    <label
                                                                        for="yes_reg">{{__('common.Yes')}}</label>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <input type="radio"
                                                                           class="common-radio "
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <input type="radio"
                                                                           ...
                                                                           value="1">
                                                                    <label
                                                                        for="contact_yes">{{__('common.Yes')}}</label>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="radio"
                                                                           ...
                                                                           value="0">
                                                                    <label
                                                                        for="contact_no">{{__('common.No')}}</label>
                                                                </div>
                                                            </div>
