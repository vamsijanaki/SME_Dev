                        ...
                        @if(isset($plans))
                            @foreach ($plans as $plan)
                                ...
                                <div class="col-xl-4 col-md-6">
                                    ...
                                    <div class="couse_wizged single_pricing_plan row_padding">

                                        <div class="course_content pt-1">
                                                ...
                                                <div class="progress_percent flex-fill text-right">
                                                    <div class="progress theme_progressBar ">
                                                        <div class="progress-bar" role="progressbar"
                                                             style="width: {{round($plan->loginUserTotalPercentage)}}%"
                                                             aria-valuenow="25"
                                                             aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                    <p class="font_14 f_w_400">{{round($plan->loginUserTotalPercentage)}}
                                            ...
                                            <div class="course_less_students">
                                                ...
                                                <a>
                                                    <i class="ti-timer"></i>{{$plan->remaining()}} {{__('org.Day Remaining')}}
                                                </a>
